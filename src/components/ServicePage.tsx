...
function ServicePage() {
  return (
    <div className="w-screen h-[190rem] sm:h-[120rem] bg-[#000614] overflow-x-hidden">
      <div className="flex items-center justify-center flex-col">
        <p className="text-white text-3xl">Our Services</p>
        <Image src="/Line.svg" alt="line" width={250} height={50} />
      </div>
      {/* section1 */}
      <div className="mt-[7rem] flex justify-around flex-col sm:flex-row px-[2rem]">
        ...
        <div className="mt-[7rem] sm:ml-[-25rem]">
      ...
      <div>
        <div className="relative px-[2rem]">
          ...
          <div className="flex flex-col sm:flex-row justify-between absolute top-[5rem]">
            <div className="mt-[7rem] order-2 sm:order-1">
              <p className="text-[#0047FF] text-2xl font-bold w-[23rem] text-center ">
                Features of our
                <br />
            ...
            <div className="flex flex-col gap-[2rem] ml-[0rem] order-1 sm:ml-[14rem] sm:order-2">
              <p className="text-white text-6xl font-bold ">
                Mobile App Development
              </p>
              <p className="text-white w-[21rem] sm:w-[37rem]">
      ...
      {/* section3 */}
      <div className="mt-[70rem] px-[2rem] sm:mt-[25rem] flex flex-col sm:flex-row justify-around gap-[20rem]">
        <div className="flex flex-col gap-[2rem]">
          <p className="text-white text-6xl font-bold">
          Web3 Development
          </p>
        ...
        <div className="mt-[-13rem] sm:mt-[7rem] sm:ml-[-25rem]">
          <p className="text-[#0047FF] text-2xl font-bold w-[23rem] text-center ">
            Features of our
            <br /> Product Design and Strategy
          </p>
